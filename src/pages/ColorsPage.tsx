...
const colors = [
  ...
  { name: 'Neutral', base: 'gray', label: 'Neutral Gray', desc: '中性色，用于文字、边框、基础背景', steps: [0, 50, 100, 200, 300, 400, 500, 600, 700, 800, 900] },
  { name: 'Surface', base: 'surface', label: 'Surface Layer', desc: '表面层级色板，用于大背景区和轻交互背景', steps: [50, 100] },
]

const defaultSteps = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900]

const semanticTokens = [
  { token: '--surface-base', desc: '基础表面，用于页面、卡片、输入框默认背景', type: 'bg', paletteRef: 'gray-0' },
  { token: '--surface-muted', desc: '弱化表面，用于侧边栏、表头，以及中性禁用表面', type: 'bg', paletteRef: 'gray-50' },
  { token: '--surface-subtle', desc: '大面积弱对比表面，用于大背景区、Tag、次级承载', type: 'bg', paletteRef: 'surface-50' },
  { token: '--surface-hover', desc: '轻交互 hover 表面，用于列表项、轻量按钮、关闭按钮等 hover 背景', type: 'bg', paletteRef: 'surface-100' },
  { token: '--surface-selected', desc: '选中态表面，用于导航 / Menu item 的选中背景', type: 'bg', paletteRef: 'primary-25' },
  { token: '--text-primary', desc: '主要文字颜色', type: 'text', paletteRef: 'gray-800' },
  { token: '--text-secondary', desc: '次要文字颜色', type: 'text', paletteRef: 'gray-600' },
  { token: '--text-tertiary', desc: '辅助文字颜色（提示、占位）', type: 'text', paletteRef: 'gray-400' },
  { token: '--text-disabled', desc: '禁用文字颜色', type: 'text', paletteRef: 'gray-300' },
  { token: '--text-inverse', desc: '反白文字颜色', type: 'text', paletteRef: 'gray-0' },
  { token: '--text-link', desc: '链接文字颜色', type: 'text', paletteRef: 'primary-700' },
  { token: '--border-primary', desc: '主边框颜色', type: 'border', paletteRef: 'gray-200' },
  { token: '--border-secondary', desc: '次要边框颜色（输入框）', type: 'border', paletteRef: 'gray-300' },
  { token: '--border-focus', desc: '聚焦态边框颜色', type: 'border', paletteRef: 'primary-700' },
  { token: '--fill-primary', desc: '主填充色', type: 'bg', paletteRef: 'primary-700' },
  { token: '--fill-hover', desc: '悬浮填充色', type: 'bg', paletteRef: 'primary-800' },
  { token: '--fill-active', desc: '按下填充色', type: 'bg', paletteRef: 'primary-900' },
  { token: '--fill-disabled', desc: '强调型填充的禁用态，用于主按钮、已选控件等高强调元素', type: 'bg', paletteRef: 'gray-300' },
  { token: '--action-fg-default', desc: '轻量操作前景色，适用于 icon 按钮和文字按钮默认态（灰黑场景）', type: 'text', paletteRef: 'gray-600' },
  { token: '--action-fg-default-hover', desc: '轻量操作前景色 hover，适用于 icon 按钮和文字按钮（灰黑场景）', type: 'text', paletteRef: 'gray-800' },
  { token: '--action-fg-brand', desc: '品牌操作前景色，适用于 icon 按钮和文字按钮默认态（蓝色场景）', type: 'text', paletteRef: 'primary-700' },
  { token: '--action-fg-brand-hover', desc: '品牌操作前景色 hover，适用于 icon 按钮和文字按钮（蓝色场景）', type: 'text', paletteRef: 'primary-800' },
  { token: '--action-fg-disabled', desc: '轻量操作禁用态前景色', type: 'text', paletteRef: 'gray-300' },
]
